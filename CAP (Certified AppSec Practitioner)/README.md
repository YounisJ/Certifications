...
<details>
  <summary><b>10. TLS security</b></summary>
...
TLS 1.2 uses symmetric encryption to secure the connection
...
TLS 1.3 uses asymmetric encryption to secure the connection
